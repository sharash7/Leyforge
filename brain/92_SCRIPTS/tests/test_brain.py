...
class BrainAcceptanceTests(unittest.TestCase):
    ...
    def test_08_BRAIN_AT_008_handoff_continuation(self) -> None:
        ...
        w0_harness_to_readiness = self.by_id["HANDOFF-20260906-004"]
        self.assertEqual(w0_harness_to_readiness.metadata["status"], "superseded")
        self.assertEqual(w0_harness_to_readiness.metadata["from_work"], "WORK-20260906-004")
        self.assertEqual(w0_harness_to_readiness.metadata["next_gate"], "R7")
        ...
        w1_to_w2 = self.by_id["HANDOFF-20260906-006"]
        self.assertEqual(w1_to_w2.metadata["status"], "superseded")
        self.assertEqual(w1_to_w2.metadata["from_work"], "WORK-20260906-006")
        self.assertEqual(w1_to_w2.metadata["next_gate"], "R7")
        self.assertEqual(w1_to_w2.metadata["next_package"], "R7-W2-NETWORK-PERSISTENCE-RECOVERY-MIGRATION-READINESS")
        ...
        repair_to_rerun = self.by_id["HANDOFF-20260908-003"]
        self.assertEqual(repair_to_rerun.metadata["status"], "superseded")
        self.assertEqual(repair_to_rerun.metadata["from_work"], "WORK-20260908-002")
        self.assertEqual(
            repair_to_rerun.metadata["next_package"],
