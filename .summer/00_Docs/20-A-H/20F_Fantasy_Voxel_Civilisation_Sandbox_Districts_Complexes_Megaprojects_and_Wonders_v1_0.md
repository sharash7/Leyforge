...
### Settlement Composition, Shared-Service Complexes, Civilisation-Scale Project Graphs and Maintained World-Scale Works

**Version 1.0 — Reconciled Production Companion Draft**  
**Date:** 8 August 2026  
**Production Status:** Active Document Set 20 v1.0 Reconciliation  
**Supersedes:** `20F_Fantasy_Voxel_Civilisation_Sandbox_Districts_Complexes_Megaprojects_and_Wonders_v0_2` for active production direction  
**Master Authority:** Document 20 v1.0  
**Settlement Growth / Planning / Player Plan Authoring:** Document 19 v1.0  
**Persistent Structures / Physical Damage / Occupation / Restoration:** Document 12 v1.0  
**Official Blueprint / Plan / Complex Source:** Document 22I Blueprint Forge  
**Lower-Level Settlement Functions:** Documents 20A–20E v1.0  
**Culture / Faction / Biome / Realm Composition:** Document 20G (pending v1.0 reconciliation)  
**Canonical Blocks / Items / Recipes / Resources:** Documents 03–06 v1.0  
**People / Jobs / Residents / Operators:** Document 07 v1.0  
**Automation / Machine Networks:** Document 08 v1.0  
**Magic / Magical Networks:** Document 09 v1.0  
**World / Terrain / Biome Context:** Documents 10–11 v1.0  
**Government / Law / Territory / Political Authority:** Document 13 v1.0  
**Dimensions / Realm Truth:** Document 14 v1.0  
**Quest / Event / Incident Lifecycle:** Document 15 v1.0  
**Combat:** Document 16 v1.0  
**UI / Player Trust:** Document 17 v1.0  
**Godot + Summer Engine Technical Authority:** Document 18 v1.0  
**Economy / Contracts / Public Finance / Megaproject Procurement:** Set 27  
**Dialogue / Social Willingness / Knowledge / Culture-in-Use:** Set 28  
**Health / Fatigue / Biological Consequences:** Set 29  
**Movement / Travel / Route Traversal:** Set 30  
**Maritime / Ports / Vessels / Floating & Coastal Specialist Systems:** Set 26  
**Production Governance / Registry / Lifecycle:** Set 25  
**Project Lead and Final Authority:** Ash

20F is Leyforge's **composition and civilisation-scale project layer**. It coordinates real lower-level buildings, parcels, routes, utilities, people, inventories, services, construction projects and events into coherent clusters, districts, campuses, complexes, capitals, megaprojects and wonders.

It does not replace those systems with abstract city-builder bonuses.

> **Locked Composition Rule**
>
> **A district, campus, complex, megaproject or wonder coordinates functioning lower-level content. It does not manufacture Housing, Provisions, Health, Work, Safety, Infrastructure, Morale, trade, power, mana, military strength or prestige merely because a plan boundary or giant structure exists.**

> **Fifteen-Definition Preservation Rule**
>
> **All 15 universal definitions owned by 20F v0.2 are protected during this reconciliation. They may be clarified, reclassified under Set-25 lifecycle governance, or have ownership boundaries corrected, but they are not silently deleted or renumbered.**

> **Project-Graph Rule**
>
> **Complexes, megaprojects and wonders are graphs of independently saved subprojects. Enabling works, roads, utilities, supply yards, workforce support, contracts, phases, commissioning, partial activation, damage, occupation, maintenance, restoration and abandonment remain visible and authoritative.**

> **No Hidden Capacity Rule**
>
> **Incomplete, decorative, uncommissioned or disconnected shells provide no hidden service. A Hospital Complex requires functioning health services; a Citadel requires functioning defence components; a Residential District requires real homes; a Wonder requires completed, authorised and maintained subprojects plus its explicitly registered effect profile.**

> **World-Effect Rule**
>
> **A wonder may have a bounded civilisation/regional/world-state effect only where that effect is explicitly registered, commissioned, maintained and handed to the authoritative owner system. “Wonder” is never a licence for arbitrary global bonuses.**

> **POC Retirement Rule**
>
> **20F's old Technical POC / Forest Hamlet / post-POC Alpha milestone language is legacy validation provenance only. Generic plan-validation fixtures survive; the production game is not architecturally dependent on the retired POC scenario.**

> **Canonical Construction Rule**
>
> **Every 20F subproject ultimately consumes canonical Blocks/Block Inventory Projections and genuine Items/components through Document 20. Duplicate recoverable Block Items remain forbidden under FR-00-20-006.**

---

# Revision 1.0 Reconciliation Summary

The v0.2 source already established the correct city-scale philosophy: adaptive plans coordinate real content rather than acting like SimCity-style zones, and megaprojects remain real construction graphs rather than instant unlocks. fileciteturn58file17L1-L18

Version 1.0 therefore performs a **production ownership reconciliation, not a redesign**.

The following are locked:

- all **15 universal 20F definitions** remain protected;
- the planning ladder remains `Building → Parcel → Cluster → District → Campus/Complex → Settlement Plan → Megaproject/Wonder`;
- official editable source remains Blueprint Forge;
- runtime bake products remain deterministic and disposable/rebuildable;
- construction/subproject graphs remain authoritative for reservations, labour, contracts, dependencies and progress;
- persistent plan/structure/world records retain occupancy, services, networks, condition, damage, ownership, history and active maintained effects;
- shared services cannot double-count component capacity;
- plans remain adaptive and may be organic, mixed-use, vertical, underground, floating, underwater or culture/realm specific;
- player-authored plans remain restricted compatible content and cannot redefine universal IDs, protected effects, migrations or server authority;
- megaprojects/wonders remain damageable, occupiable, capturable where valid, maintainable, restorable and historically persistent.

The post-27–30 ownership corrections are:

- **Set 27** owns project contracts, procurement, finance, wages, taxes, trade and economic consequences;
- **Set 28** owns social willingness, negotiation, relationships, individual knowledge/belief and social consequences;
- **Set 29** owns Health, injury, Fatigue, exposure and biological consequences;
- **Set 30** owns actor/vehicle pathfinding, travel, accessibility and physical arrival;
- **Set 26** owns specialist maritime/floating-vessel/port execution;
- **Document 13** owns political authority, law, territory, citizenship, occupation and formal political outcomes;
- **Document 14** owns dimension/realm truth;
- **Document 15** owns event/incident/ceremony/sabotage lifecycle;
- **Document 16** owns combat/siege resolution;
- **20A–20E** own the actual lower-level settlement services coordinated by 20F;
- **20G** owns culture/faction/biome/realm composition packs rather than 20F hard-coding every architectural expression.

---

# v1.0 Source-of-Truth Contract

The canonical flow is:

```text
20F Universal Plan / Complex / Megaproject Definition
→ 22I Blueprint Forge editable source graph
→ deterministic placement / network / validation bake
→ Document-19 settlement proposal where planner/player initiated
→ Document-20 ConstructionProject / independently saved subproject graph
→ Document-12 persistent structures + parcel/plan runtime records
→ functioning 20A–20E component services
→ external owner systems consume bounded evidence/effects
→ settlement needs, events, UI and world history
```

No later layer may silently rewrite an earlier authority.

## Plan Intent Versus World Truth

20F owns:

- reusable plan meaning;
- required/optional roles;
- substitutions;
- parcel composition;
- shared-service coordination;
- phase/dependency expectations;
- bounded effect contracts;
- civilisation-scale project semantics.

It does **not** own:

- the exact voxel art/source — 22I;
- the authoritative construction project — Document 20;
- the physical placed structure — Document 12;
- individual service truth — 20A–20E and specialist owners;
- people — Document 07;
- economic truth — Set 27;
- social truth — Set 28;
- biology — Set 29;
- movement — Set 30/26;
- political authority — Document 13;
- realm truth — Document 14.

---

# v1.0 Shared-Service and Anti-Double-Counting Contract

A complex/campus may coordinate shared:
...
- grounds;
- administration;
- power/mana connections.

Shared infrastructure may reduce duplication or improve effective service.

It may **not** duplicate the output of component buildings.

Examples:

- two clinics inside a Hospital Complex remain two real health-service providers;
- a Citadel's wall, barracks, armoury and command facilities remain separate functioning components;
- a Market/Civic Centre coordinates real market/civic services rather than creating free trade or government;
- a Mage/Automation Campus coordinates real magical/machine facilities rather than multiplying mana or throughput.

The aggregate plan may publish a bounded coordination summary, but every quantity must reconcile to authoritative components.

---

# v1.0 Megaproject and Wonder Contract

A civilisation-scale project may require:

- site acquisition/authority;
- enabling roads/bridges/ports;
- utilities;
- supply yards;
- workforce support;
- specialist labour;
...
Each requirement remains owned by its specialist system.

## Partial Activation

Partial activation is allowed only where a declared phase is independently safe and functional.

An unfinished shell cannot inherit the final wonder effect.

## Bounded Maintained Effects

A `WonderEffectProfile` may declare:
...
The actual outcome is committed by the owning external system.

## Failure and History

Megaprojects/wonders may become:

- delayed;
- over-budget through Set-27 economics;
...
The plan and structure history survives these transitions.

---

# v1.0 District and Planner Contract

A district is **not a coloured zone that spawns abstract buildings**.

It is a plan that:

- reserves/scores parcels;
- declares roles and substitutions;
- connects route/utility spines;
- evaluates lower-level service coverage;
- selects approved actual blueprints;
- creates real projects;
- adapts to terrain/culture/realm constraints;
- preserves expansion space.

Document 19 owns planner selection and project proposal.

20F provides the plan vocabulary and validation contracts.

Set 30 supplies real travel/access evidence.

20D supplies physical route infrastructure.

20G supplies composition packs.

---

# v1.0 Player-Creator Contract

Players may author compatible:
...
through the restricted creation systems.

Player-authored content may define layout and compatible choices but cannot alter:

- universal definition IDs;
- seven-needs ownership;
- protected world-effect contracts;
- migration rules;
- Set-25 lifecycle authority;
- server authority;
- protected sites/worldgen guarantees;
- specialist system rules;
- resource conservation.

Drafting remains free where the creator permits it.

Actual survival-world construction consumes real resources, labour and authority.

---

# v1.0 Post-POC Production Rule

The v0.2 source correctly states that 20F added no complete definition to the old Technical POC/Forest Hamlet roster and used reduced fixtures to validate planning architecture. fileciteturn58file18L1-L11

For v1.0:

- those fixtures remain useful regression tests;
- “post-POC Alpha” is no longer an active production lifecycle class;
- Farmstead Cluster, Market Square/Civic Centre and every other valid 20F definition are governed by Set-25 lifecycle classification and 20H v1.0;
- no production system may require the Forest Hamlet, fixed watchtower raid or any other retired POC identity.
...
|---|---|---|
| `20F-HIDDEN-CAPACITY` | Fatal | Plan/complex/wonder generated service without functioning authoritative components/effect. |
| `20F-DOUBLE-COUNT` | Fatal | Shared-service aggregation counted component output more than once. |
| `20F-PROJECT-OWNER-VIOLATION` | Fatal | 20F attempted to replace authoritative Document-20 project/subproject state. |
| `20F-STRUCTURE-OWNER-VIOLATION` | Fatal | Plan attempted to replace Document-12 physical structure truth. |
| `20F-ECON-OWNER-VIOLATION` | Fatal | Plan committed Set-27 economic/contract/public-finance state. |
| `20F-SOCIAL-OWNER-VIOLATION` | Fatal | Plan committed Set-28 willingness/relationship/knowledge state. |
| `20F-BIOLOGY-OWNER-VIOLATION` | Fatal | Plan directly changed Set-29 biological state. |
| `20F-MOVE-OWNER-VIOLATION` | Fatal | Plan directly moved/pathed actors outside Set 30/26. |
| `20F-POLITICS-OWNER-VIOLATION` | Fatal | Plan created political authority/law/territory outside Document 13. |
| `20F-DIMENSION-OWNER-VIOLATION` | Fatal | Plan invented/overrode Document-14 realm truth. |
| `20F-WONDER-EFFECT-UNREGISTERED` | Fatal | Wonder applied an effect absent from an approved bounded effect profile. |
| `20F-POC-LEAK` | Fatal | Active production depends on retired POC/Forest-Hamlet identity. |
| `20F-BLOCKITEM-DUPLICATE` | Fatal | Subproject references a fake duplicate Item for a recoverable Block. |

---

# v1.0 Production Acceptance Addendum

20F v1.0 is accepted when:

- [x] all 15 universal definitions are preserved;
- [x] lower-level services remain real 20A–20E functions;
- [x] districts do not spawn abstract capacity;
- [x] shared services do not double-count;
- [x] megaprojects remain independently saved subproject graphs;
- [x] partial activation requires safe declared commissioning;
- [x] wonder effects are bounded, registered and maintenance-aware;
- [x] Blueprint Forge remains official editable source;
- [x] bake products remain deterministic/rebuildable;
- [x] Document 19 remains planner/player-plan owner;
- [x] Document 20 remains ConstructionProject owner;
- [x] Document 12 remains persistent physical structure owner;
- [x] Set 27/28/29/30 boundaries are respected;
- [x] Set 26 maritime specialist boundaries are respected;
- [x] Document 13 political authority is respected;
- [x] Document 14 realm truth is respected;
- [x] POC milestone language is provenance only;
- [x] canonical Block/Item identity remains enforced.

---

# Retained v0.2 Detailed Specification

The complete v0.2 specification follows as the detailed baseline. Where older wording conflicts with the v1.0 contract above, the v1.0 ownership/reconciliation rule governs.
...
| 20 v1.0 / 20H v0.2 baseline pending 20H v1.0 reconciliation | Shared lifecycle, semantic contracts, stable catalogue IDs, stage mapping, delivery scope, production states and change control. |
...
**20F v1.0 preserves the full city-scale vision while making its most important architectural rule explicit: civilisation-scale plans coordinate reality; they do not replace reality.**

A Residential District still needs **real homes**.

A Hospital Complex still needs **real health facilities, staff, supplies and access**.

A Citadel still needs **real walls, gates, guards, armouries, routes and sustainment**.

A Market/Civic Centre still needs **real economic and civic services**.

A floating or maritime complex still consumes **Set-26 specialist infrastructure and movement**.

A capital megaproject still consumes **real materials, labour, contracts, logistics and time**.

And a Wonder only changes the wider world through a **bounded, registered, maintained effect** backed by completed authoritative subprojects.

**Next Document Set 20 reconciliation: 20G — Culture, Faction, Biome and Realm Building Packs.**
